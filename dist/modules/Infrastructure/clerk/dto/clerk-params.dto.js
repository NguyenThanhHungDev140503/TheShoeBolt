...
exports.UserIdParamDto = exports.SessionIdParamDto = void 0;
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Matches)(/^user_[a-zA-Z0-9]+$/, {
        message: 'Invalid user ID format. User ID must start with "user_" followed by alphanumeric characters.'
    }),
    __metadata("design:type", String)
], UserIdParamDto.prototype, "userId", void 0);
//# sourceMappingURL=clerk-params.dto.js.map